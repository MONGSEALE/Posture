...
class IntroductionViewController_iPhone : UIViewController{
    ...
    private lazy var nextButton = PrimaryButton(title: "다음",isHidden: false,isiphone: true)
    ...
    private lazy var introductionPages : [UIViewController] = [
        ...
        ThirdIntroductionViewController_iPhone()
...
#Preview{
    IntroductionViewController_iPhone()
}


// MARK: - UIPageViewControllerDataSource
extension IntroductionViewController_iPhone: UIPageViewControllerDataSource {
...
extension IntroductionViewController_iPhone: UIPageViewControllerDelegate {
